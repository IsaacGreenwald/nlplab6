...
While you can do this by just typing in the whole dictionary, 
it's probably easier to write a small snippet of code to create this.
"""
ptb_to_universal = {}
for uni_tag, ptb_tags in universal_to_ptb.items():
    for ptb_tag in ptb_tags:
        ptb_to_universal[ptb_tag] = uni_tag
